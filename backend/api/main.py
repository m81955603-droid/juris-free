...
from .routes import llm, embeddings, health, library, muestras, cases, calendar, clients, documents, search, ocr, scanner_export, convert, admin, session
...
app.include_router(session.router,  prefix="/api/v1/session",   tags=["Sesion"])
